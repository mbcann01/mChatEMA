...
# Data check
about_data(daily)
# 2016-07-22: 7,378 observations and 146 variables in the data

test_that("The number of variables hasn't changed", {
  expect_equal(ncol(daily), 146)
})
```
...
# Data check
about_data(daily)
# 2016-07-22: 7,378 observations and 168 variables in the data

test_that("The number of variables hasn't changed", {
  expect_equal(ncol(daily), 168)
})
```
...
# Data check
about_data(daily)
# 2016-07-22: 7,378 observations and 128 variables in the data

test_that("The number of variables hasn't changed", {
  expect_equal(ncol(daily), 128)
})
```
...
# Data check:
about_data(daily)
# 2016-07-22: 7,378 observations and 158 variables in the data

test_that("The number of variables hasn't changed", {
  expect_equal(ncol(daily), 158)
})
```
...
about_data(daily)
# 2016-07-22: 7,378 observations and 180 variables in the data

test_that("The number of variables hasn't changed", {
  expect_equal(ncol(daily), 180)
})
```
...
```{r save_rdata}
about_data(daily)
save(daily, file = "data/daily_2016_07_19.RData")
```

**Save a .csv**
```{r save_csv}
write_csv(daily, path = "data/daily_2016_07_19.csv")
```
