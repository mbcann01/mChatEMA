...
daily <- daily %>%
  ...
  mutate(
    ...
    # Create age variable
    age = round(difftime(date, dob, units = "sec") / 31556926)
  )
# Data check
...
# Data check
about_data(daily)
# 2016-07-22: 7,378 observations and 136 variables in the data
...
about_data(daily)
# 2016-07-22: 7,378 observations and 188 variables in the data
