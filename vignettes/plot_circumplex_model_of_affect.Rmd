...
1. The plots treat all emotions WITHIN each quadrant as equivalent. For example, Happy and Excited are both in quadrant 1. The plots don’t currently differentiate between the two.


2. We don’t currently have an equivalent number of emotions from each quadrant.

3. It may be more informative to limit to substance users. Some people will not use at all; however, among those that do use, XYZ may be a predictor.
