...
```{r plot_comp_aaa}
acts <- select(daily, other_act, sit_act, sleep_act, stand_act, walk_act, talk_act, pre_who)
...
acts <- select(daily, bike_yest, run_yest, cleaning_yest, none_yest)
...
```{r plot_comp_sub}
subs <- select(daily, alc_sub, cig_sub, mar_sub, opi_sub, stim_sub, herb_sub, other_sub, none_sub, heavy_drink)
