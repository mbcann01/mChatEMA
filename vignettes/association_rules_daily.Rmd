...
Still rough. Need to dig deeper. Find rules that include substances, acitivities, etc. Not just feelings.

Ignore rules that are just mood predicting mood. These aren't very interesting. This really amounts to not including any of the mood items in the rhs.
